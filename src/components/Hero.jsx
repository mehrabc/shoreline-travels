    ...
    return (
        <div className="w-full h-screen relative">
            ...
            <div className='absolute w-full top-0 h-full flex flex-col justify-center text-center text-white  p-4'>
                ...
                <form className='flex justify-between items-center w-full max-w-[700px] border mx-auto p-1
                rounded-md text-black bg-gray-100/70'>
                    <div className=''>
                    ...
                    <div>
                        <button><AiOutlineSearch size={20} className='' /></button>
                    </div>
                </form>
            </div>
        </div>
